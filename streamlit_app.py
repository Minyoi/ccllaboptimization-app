...
with col[0]:
    ...
    # st.bar_chart(df1_1, y="total_samples")
    # st.write("Culture Results")
    # st.write(df1)
    # st.write("Culture Result Trends")
    # st.line_chart(df1_2)
    # st.write("Culture Contaminated and Smear Negative:")
    # st.line_chart(data=cult_cont_smear_neg_summary_df, x='month_processed', y='percentage')
    st.write('Total Culture Samples processed')
    ...
    #culture_tats['month_processed'] = culture_tats['month_processed'].astype(str)
    culture_tats = culture_tat.reset_index()
